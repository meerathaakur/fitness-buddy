...
export const joinChallengeAPI = `${BASE_URL}/challenges/:challengeId/join`;
export const updateChallengeProgressAPI = `${BASE_URL}/challenges/:challengeId/progress`;
export const getChallengeLeaderboardAPI = `${BASE_URL}/challenges/:challengeId/leaderboard`;
...
export const markAllNotificationsAsReadAPI = `${BASE_URL}/notifications/mark-all-read`;
