...
export default function Messages() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Messages"
        subtitle="Chat with your fitness buddies"
        backTo="/dashboard"
        showHome={true}
      />
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredConversations.map((conversation) => (
              <div
                ...
                className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors ${selectedChat === conversation.id ? 'bg-primary-50 border-primary-200' : ''
                  }`}
              >
